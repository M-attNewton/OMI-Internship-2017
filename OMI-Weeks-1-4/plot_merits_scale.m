...
function [merit_R_St,merit_R_resamplet,merit_R_filtert,merit_R_Bt,merit_R_Ft] = plot_merits_scale(num_intervals,R_St,R_resamplet,R_filtert,R_Bt,R_Ft,interval_list)
