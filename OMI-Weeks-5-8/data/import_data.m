% Imports all the data from csv file, putting the values (price and sizes) into a matrix and then the DateTime values into a seperate matrix.
...
filename = 'C:\Users\mnewton\Documents\MATLAB\Final\data\XOM_MarketDepth_Oct2016.csv';
delimiter = ',';
startRow = 3;
