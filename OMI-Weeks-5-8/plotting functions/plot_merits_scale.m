% A plot of the log determinant of each of the dependency matricies (merits) where the x-axis represents time as an expanding window.
...
function [merit_R_St,merit_R_Sresamplet,merit_R_Sfiltert,merit_R_Bt,...
    ...
    = plot_merits_scale(num_intervals,R_St,R_Sresamplet,R_Sfiltert,R_Bt,...
